                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group" :class="{'has-danger': errors.identity_document_type_id}">
                            ...
                            <el-select v-model="form.identity_document_type_id" filterable @change="changeIdentityDocType">
                    ...
                    <div class="col-md-6">
                        <div class="form-group" :class="{'has-danger': errors.number}">
                            ...
                            <x-input-service :identity_document_type_id="form.identity_document_type_id_new" v-model="form.number" @search="searchNumber"></x-input-service>
        ...
        methods: {
            initForm() {
                ...
                this.form = {
                    ...
                    identity_document_type_id_new: '6',
                    number: '',
                    name: null,
                    trade_name: null,
                    country_id: '040000PE',
            ...
            changeIdentityDocType(){
                ...
                this.form.identity_document_type_id_new = (this.form.identity_document_type_id === '06000006')?'6':'1';
            },
            setDataDefaultCustomer(){

                if(this.form.identity_document_type_id == '06000000'){
                    this.form.number = 88888888
            ...
            searchNumber(data) {
                this.form.name = (this.form.identity_document_type_id === '06000001')?data.nombre_completo:data.nombre_o_razon_social;
