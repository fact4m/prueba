    ...
    <el-dialog :title="titleDialog" :visible.sync="showDialog" @open="create" width="30%"
        ...
        <div class="row mb-4">
            <div class="col-lg-6 col-md-6 col-sm-12 text-center font-weight-bold">
                <p>Imprimir A4</p>
                <button type="button" class="btn btn-lg btn-info waves-effect waves-light" @click="clickPrint2('a4')">
                    <i class="fa fa-file-alt"></i>
                </button>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 text-center font-weight-bold">
                <p>Imprimir Ticket</p>
                <button type="button" class="btn btn-lg btn-info waves-effect waves-light" @click="clickPrint2('ticket')">
...
//            },
            ...
            clickPrint2(format){
                window.open(`/${this.resource}/to_print2/${this.form.id}/${format}`, '_blank');
            },
            clickDownload() {
