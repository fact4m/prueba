            ...
            <table class="voucher-totals-right">
                ...
                @if($document->total_discount)
                    @if($document->total_discount > 0)
                        <tr>
                            <td class="text-right segunda" width="70%">DESCUENTO TOTAL: {{ $document->currency_type_code }}</td>
                ...
                @if($document->total_taxed > 0)
                    <tr>
                        <td class="text-right segunda" width="70%">OP. GRAVADAS: {{ $document->currency_type_code }}</td>
